...
restarts_data<- read.csv("O:/Business Process Engineering/BPEAs/Automated SAS Projects/Automated Report Data/Edits Dashboard Data/WORK_RESTARTS_DATA.csv",header =TRUE)
...
data_7<- filter(data_7, data_7$Processing_Time <90)
...
Edits_Model <- lm(Processing_Time ~ EDIT_COUNT,data = data_6)
summary(Edits_Model)

cor(data_6$EDIT_COUNT,data_6$Processing_Time)
...
Restarts Pivot Table
=========================================
```{r}
rpivotTable(restarts_data,
            aggregatorName = "Count",
            rendererName = "Heatmap")
```
