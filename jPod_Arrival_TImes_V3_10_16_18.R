...
data <- data[c(2,4,5,17,10,11,18,19)]
...
data_adv_sw <-data_adv_sw[c(2,3,4,5,6,7,8)]
data_ot<-data_ot[c(2,3,4,5,6,7,8)]
data_adv_ot<-data_adv_ot[c(2,3,4,5,6,7,8)]
data_claims<-data_claims[c(2,3,4,5,6,7,8)]
data_rmd<-data_rmd[c(2,3,4,5,6,7,8)]
data_sw<-data_sw[c(2,3,4,5,6,7,8)]
